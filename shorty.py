...
st.sidebar.write(
"""
This app uses the HuggingFace API to classify keyphrases.
...
with MainTab:
    ...
    with st.form(key="my_form"):
        ...
        labels_from_st_tags = st_tags(
            value=["positive", "negetive", "nuteral"],
            maxtags=3,
            suggestions=["positive", "negetive", "nuteral"],
            label="",
        )
    ...
    if not submit_button and not st.session_state.valid_inputs_received:
        ...
        try:
            ...
            #if KeyError: 'scores' then print the error
        except KeyError:
